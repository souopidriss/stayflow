...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-calendar-check" style="color:#1E88E5"></i> Gestion des Réservations</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.reservations.show', $r->id_reservation) }}"
                               class="btn btn-info btn-sm">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.reservations.edit', $r->id_reservation) }}"
                               class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST"
                                  action="{{ route('admin.reservations.destroy', $r->id_reservation) }}"
