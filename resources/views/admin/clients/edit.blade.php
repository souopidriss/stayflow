...
<head>
    ...
    <title>StayFlow — Modifier Client</title>
...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-user-edit" style="color:#1E88E5"></i>
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.clients.update', $client->id_client) }}">
            @csrf
            @method('PUT')
