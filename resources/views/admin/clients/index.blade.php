...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-users" style="color:#1E88E5"></i> Gestion des Clients</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.clients.show', $client->id_client) }}"
                               class="btn btn-info btn-sm">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.clients.edit', $client->id_client) }}"
                               class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST"
                                  action="{{ route('admin.clients.destroy', $client->id_client) }}"
