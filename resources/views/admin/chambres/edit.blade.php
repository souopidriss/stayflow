...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-edit" style="color:#1E88E5"></i> Modifier Chambre {{ $chambre->numero }}</h1>
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.chambres.update', $chambre->id_chambre) }}">
            @csrf
            @method('PUT')
                ...
                <select name="id_type" required>
                    ...
                    @foreach($types as $type)
                        <option value="{{ $type->id_type }}"
                            ...
                            {{ $type->libelle_type }} — {{ number_format($type->prix_nuit, 0, ',', ' ') }} FCFA
                        </option>
                    @endforeach
                </select>
                @error('id_type')
            ...
            <div class="form-group">
                ...
                <select name="statut" required>
                    ...
                    <option value="Occupé"      {{ $chambre->statut == 'Occupé'      ? 'selected' : '' }}>Occupé</option>
