...
<head>
    ...
    <title>StayFlow — Nouvelle Chambre</title>
...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-plus" style="color:#1E88E5"></i> Nouvelle Chambre</h1>
        ...
        <form method="POST" action="{{ route('admin.chambres.store') }}">
                ...
                <select name="id_type" required>
                    ...
                    @foreach($types as $type)
                        <option value="{{ $type->id_type }}"
                            {{ old('id_type') == $type->id_type ? 'selected' : '' }}>
            ...
            <div class="form-group">
                ...
                <input type="text" name="numero" value="{{ old('numero') }}"
                       placeholder="Ex: 101, 202, 305..." required/>
                @error('numero')
                    <div class="error-msg">{{ $message }}</div>
                @enderror
            </div>
