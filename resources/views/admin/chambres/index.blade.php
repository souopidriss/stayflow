...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-bed" style="color:#1E88E5"></i> Gestion des Chambres</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.chambres.show', $chambre->id_chambre) }}"
                               class="btn btn-info btn-sm">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.chambres.edit', $chambre->id_chambre) }}"
                               class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST"
                                  action="{{ route('admin.chambres.destroy', $chambre->id_chambre) }}"
