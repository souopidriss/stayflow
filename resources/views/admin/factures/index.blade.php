...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-file-invoice" style="color:#1E88E5"></i> Gestion des Factures</h1>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.factures.show', $facture->id_facture) }}"
                               class="btn btn-info btn-sm">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('admin.factures.edit', $facture->id_facture) }}"
                               class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <a href="{{ route('admin.factures.pdf', $facture->id_facture) }}"
