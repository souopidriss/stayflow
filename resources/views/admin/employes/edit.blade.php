...
<head>
    ...
    <title>StayFlow — Modifier Employé</title>
...
<div class="main">
    ...
    <div class="card">
        <form method="POST"
              action="{{ route('admin.employes.update', $employe->id_employe) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select name="poste" required>
                        ...
                        @foreach(['Réceptionniste','Manager','Caissier','Femme de chambre','Cuisinier','Directeur','Autre'] as $poste)
                            <option value="{{ $poste }}"
                                {{ $employe->poste == $poste ? 'selected' : '' }}>
                                {{ $poste }}
                            </option>
                        @endforeach
                    </select>
