...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .employe-info { display: flex; align-items: center; gap: 10px; }
        .employe-name { font-weight: 600; color: #333; }
        .employe-email { font-size: 12px; color: #888; }
        .badge {
...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-user-tie" style="color:#1E88E5"></i> Gestion des Employés</h1>
                    ...
                    <td>
                        <div class="employe-info">
                            ...
                            <div>
                                ...
                                <div class="employe-email">
                                    {{ $employe->user->email ?? '—' }}
                                </div>
                            </div>
                        </div>
                    </td>
                    <td><span class="badge">{{ $employe->poste }}</span></td>
                    <td>{{ $employe->telephone ?? '—' }}</td>
                    <td>
                        <div class="actions">
                            <a href="{{ route('admin.employes.show', $employe->id_employe) }}"
                            ...
                            <form method="POST"
                                  action="{{ route('admin.employes.destroy', $employe->id_employe) }}"
