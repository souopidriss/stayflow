...
<head>
    ...
    <title>StayFlow — Modifier Service</title>
...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-edit" style="color:#1E88E5"></i> Modifier Service</h1>
    ...
    <div class="card">
        <form method="POST" action="{{ route('admin.services.update', $service->id_service) }}">
            @csrf
            @method('PUT')
                ...
                <select name="id_employe">
                    ...
                    @foreach($employes as $employe)
                        <option value="{{ $employe->id_employe }}"
                            {{ $service->id_employe == $employe->id_employe ? 'selected' : '' }}>
