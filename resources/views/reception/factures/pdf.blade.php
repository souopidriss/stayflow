...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .header p { color: #7fb3d3; font-size: 12px; margin-top: 4px; }
        .facture-info {
            display: flex; justify-content: space-between;
            margin-bottom: 24px; padding: 0 24px;
        }
        .facture-num { font-size: 18px; font-weight: bold; color: #0F4C75; }
    ...
    <div class="header">
        <div style="display:flex;justify-content:space-between;align-items:center">
            ...
            <div style="text-align:right">
                <div style="font-size:12px;color:#7fb3d3">FACTURE</div>
                <div style="font-size:22px;font-weight:bold;color:#29B6F6">
                    #{{ $facture->id_facture }}
                </div>
                <div style="font-size:12px;color:#7fb3d3;margin-top:4px">
