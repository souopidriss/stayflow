...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-users" style="color:#1E88E5"></i> Clients</h1>
        <div style="display:flex;align-items:center;gap:16px">
            <a href="{{ route('reception.clients.create') }}" class="btn btn-primary">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="actions">
                            <a href="{{ route('reception.clients.show', $client->id_client) }}"
