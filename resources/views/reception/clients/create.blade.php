...
<head>
    ...
    <title>StayFlow — Nouveau Client</title>
...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-user-plus" style="color:#1E88E5"></i> Nouveau Client</h1>
    ...
    <div class="card">
        <form method="POST" action="{{ route('reception.clients.store') }}">
            @csrf
            ...
            <div class="section-title" style="margin-top:8px">
                <i class="fas fa-lock"></i> Accès au portail
            </div>
