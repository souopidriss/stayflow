...
<div class="main">
    <div class="topbar">
        <h1><i class="fas fa-bed" style="color:#1E88E5"></i> Chambres</h1>
        <div style="display:flex;align-items:center;gap:16px">
            <a href="{{ route('reception.chambres.create') }}" class="btn btn-primary">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $chambre->typeChambre->libelle_type }}</td>
                    ...
                    <td>
                        <div class="actions">
    <a href="{{ route('reception.chambres.show', $chambre->id_chambre) }}"
       class="btn btn-info btn-sm">
        <i class="fas fa-eye"></i>
    </a>
    <a href="{{ route('reception.chambres.edit', $chambre->id_chambre) }}"
       class="btn btn-warning btn-sm">
        <i class="fas fa-edit"></i>
    </a>
    <form method="POST"
          action="{{ route('reception.chambres.destroy', $chambre->id_chambre) }}"
